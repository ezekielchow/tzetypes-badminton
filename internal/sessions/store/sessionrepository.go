...
type SessionRepository interface {
	...
	UpdateSessionWithRefreshToken(ctx context.Context, tx *pgx.Tx, refreshToken string, sessionTokenExpiresAt time.Time, newSessionToken string) (models.Session, error)
