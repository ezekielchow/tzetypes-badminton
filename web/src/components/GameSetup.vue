...
const leftTopPlayer = ref("")
const leftBottomPlayer = ref("")
const rightTopPlayer = ref("")
const rightBottomPlayer = ref("")
...
const switchSides = () => {
    ...
    leftTopPlayer.value = old.rightTopPlayer
    leftBottomPlayer.value = old.rightBottomPlayer
    rightTopPlayer.value = old.leftTopPlayer
    rightBottomPlayer.value = old.leftBottomPlayer
}
            ...
            <div class="court">
                ...
                <div class="left-top-player squares">
                    <div v-if="gameType === GameTypes.GAME_TYPE_DOUBLES" class="form-group">
                        <input type="text" id="name" name="name" placeholder="Enter player name" v-model="leftTopPlayer"
                ...
                <div class="left-bottom-player squares">
                    <div class="form-group">
                        <input type="text" id="name" name="name" placeholder="Enter player name"
                            v-model="leftBottomPlayer" required :disabled="formIsLoading">
                        <div class="loading-wrapper"><img :src="loadingImage" alt="loading left top player" width="30px"
                                height="30px"></div>
                    </div>
                </div>
                <div class="right-top-player squares">
                    <div class="form-group">
                        <input type="text" id="name" name="name" placeholder="Enter player name"
                            v-model="rightTopPlayer" required :disabled="formIsLoading">
                        <div class="loading-wrapper"><img :src="loadingImage" alt="loading left top player" width="30px"
                                height="30px"></div>
                    </div>
                </div>
                <div class="right-bottom-player squares">
                    <div v-if="gameType === GameTypes.GAME_TYPE_DOUBLES" class="form-group">
                        <input type="text" id="name" name="name" placeholder="Enter player name"
                            v-model="rightBottomPlayer" required :disabled="formIsLoading">
                        <div class="loading-wrapper"><img :src="loadingImage" alt="loading left top player" width="30px"
                                height="30px"></div>
                    </div>
                </div>
